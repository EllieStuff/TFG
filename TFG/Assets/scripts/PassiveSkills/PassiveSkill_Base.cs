...
{
    public enum SkillType { IMPROVE_LIFE, IMPROVE_ATTACK_SPEED, IMPROVE_ATTACK_DAMAGE, INCREASE_PROJECTILE_AMOUNT, VAMPIRE, QUICK_CONJURING, HEAL, PIERCE, WALK_SPEED, FIRST_STRIKE, COUNT }
